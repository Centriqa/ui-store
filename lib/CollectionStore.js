...
var AbstractApiCollectionStore = (function (_super) {
    ...
    AbstractApiCollectionStore.prototype.getNextPage = function () {
        var page = this.props.page;
        if (page === this.props.count - 1)
            return;
        ++page;
        return this.setProps({
            page: page,
    ...
    AbstractApiCollectionStore.prototype.getPreviousPage = function () {
        var page = this.props.page;
        if (page === 0)
            return;
        --page;
    ...
    AbstractApiCollectionStore.prototype.setPageSize = function (pageSize) {
        return this.setProps({
            pageSize: pageSize,
            page: 0
        }, true);
...
__decorate([
    mobx_1.action
], AbstractApiCollectionStore.prototype, "getNextPage", null);
__decorate([
    mobx_1.action
], AbstractApiCollectionStore.prototype, "getPreviousPage", null);
__decorate([
    mobx_1.action
], AbstractApiCollectionStore.prototype, "setPageSize", null);
__decorate([
    mobx_1.action
