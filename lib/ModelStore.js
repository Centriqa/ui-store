...
var AbstractModelStore = (function (_super) {
    ...
    function AbstractModelStore(owner, options) {
        ...
        Object.keys(options.validationRules).forEach(function (rule) { return validationErrors[rule] = null; });
        _this.validationErrors = mobx_1.observable(validationErrors);
        return _this;
    }
    ...
    AbstractModelStore.prototype.validate = function (key, value) {
        var validation = this.validationRules[key];
        if (validation)
            this.validationErrors[key] = validation(value);
    };
    ...
    AbstractModelStore.prototype.setAttributes = function (attrs) {
        ...
        Object.keys(attrs).forEach(function (key) {
            _this.validate(key, attrs[key]);
            _this.setAttribute(key, attrs[key]);
        });
    };
    Object.defineProperty(AbstractModelStore.prototype, "hasValidationErrors", {
        get: function () {
            var _this = this;
            return !!Object.keys(this.validationErrors).find(function (key) { return !!_this.validationErrors[key]; });
        },
        enumerable: true,
        configurable: true
    });
...
__decorate([
    mobx_1.action
], AbstractModelStore.prototype, "validate", null);
__decorate([
    mobx_1.action
...
__decorate([
    mobx_1.computed
], AbstractModelStore.prototype, "hasValidationErrors", null);
__decorate([
    mobx_1.action
